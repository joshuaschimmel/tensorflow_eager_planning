...
def run_random_agent(initial_state: list = [0, 0],
    ...
    :param render: if the execution should be rendered,
        defaults to False
    :type render: bool, optional
    :return: returns the accumulated reinforcement and a list
        of reinforcements for each step
...
def get_state_generator(steps: int):
    ...
    This generator will not stop unless the calling function
    breaks the loop.
