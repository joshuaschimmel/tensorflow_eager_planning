...
class WorldModelWrapper:
    ...
    def train_model(self,
        ...
        losses = []
        test_losses = []
        column_names = ["epoch", "iteration", "loss"]
        ...
        for _ in range(test_runs):
            ...
            test_losses.append(np.array([
                # reuse training variables for plotting
                e,
                i,
                loss_value.numpy()
            ]))
